...
const I18n = (function() {
  ...
  const translations = {
    en: {
      ...
      aiNeedsMoreData: 'AI Needs More Data',
      aiCollectMoreRuns: 'You have {current} rated run(s). Collect {needed} more run(s) for AI suggestions.',
    ...
    de: {
      ...
      aiNeedsMoreData: 'KI benötigt mehr Daten',
      aiCollectMoreRuns: 'Sie haben {current} bewertete Brühung(en). Sammeln Sie {needed} weitere Brühung(en) für KI-Vorschläge.',
      showAnyway: 'Trotzdem anzeigen',
      makeThisRun: 'Diese Brühung durchführen',
      expectedRating: 'Erwartete Bewertung:',
